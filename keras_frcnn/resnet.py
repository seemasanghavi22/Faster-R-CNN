...
def get_weight_path():
    if K.common.image_dim_ordering() == 'th':
        return './model_weights/Transfer_Learning_Weights/resnet50_weights_th_dim_ordering_th_kernels_notop.h5'
    else:
        return './model_weights/Transfer_Learning_Weights/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5'
